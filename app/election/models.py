...
class Candidate(models.Model):
	...
	user = models.ForeignKey(User, verbose_name=_(u'user'), help_text=_(u'User, which is configured as candidate.'))
	election = models.ForeignKey(Election, verbose_name=_(u'election'), help_text=_(u'Election, which candidate has candidate rights.'))
